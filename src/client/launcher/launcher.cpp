...
launcher::launcher() { this->create_main_menu(); }

void launcher::create_main_menu() {
  this->main_window_.register_callback(
      "openUrl", [](html_frame::callback_params* params) {
  ...
  this->main_window_.register_callback(
      "selectMode", [this](html_frame::callback_params* params) {
        if (params->arguments.empty())
          return;
  ...
  this->main_window_.set_callback([](window* window, const UINT message,
  ...
  this->main_window_.create("IW4x-SP", 750, 500);
